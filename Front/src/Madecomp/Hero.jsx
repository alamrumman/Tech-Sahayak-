  ...
  return (
    <section className="w-full min-h-screen bg-zinc-50 p-2 sm:p-3">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:justify-center md:items-end gap-8 sm:gap-12 md:gap-16 lg:gap-20 text-black mt-12 sm:mt-16 md:mt-20">
          <div className="flex justify-center md:justify-end w-full md:w-auto">
            <div className="scale-90 sm:scale-100 md:scale-100">
              <Cardcomp />
            </div>
          </div>
